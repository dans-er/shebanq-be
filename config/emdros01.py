...
SYSTEM_NAME = "Emdros MQL"

#An informative description for this system:
SYSTEM_DESCRIPTION = "A simple interface for issuing mql-queries on an Emdros database."
...
COMMAND = sys.path[0] + "/wrappers/emdroswrapper01.py $DATAFILE $STATUSFILE $OUTPUTDIRECTORY $PARAMETERS > $OUTPUTDIRECTORY/log"
